...
export default function ProfilePage({ walletAddress, onConnect, onDisconnect }) {
  ...
  const loadUserStats = async () => {
    ...
    try {
      ...
      const API_URL = 'https://api-r4ha0h3ep-enyeks-projects-61a9bb1e.vercel.app';
      const response = await fetch(`${API_URL}/api/xp/${walletAddress}`);
